import {MLArrayUtils} from '../ml-array-utils/main.js';
...
let MLMatrixDCLU = {}; //11
{
    ...
    self.LuDecomposition = function LuDecomposition(matrix) {
...
let MLMatrixDCSVD = {}; // ???
{
    ...
    self.SingularValueDecomposition = function SingularValueDecomposition(value, options) {
...
let MLMatrixDCEVD;
{
    ...
    self.EigenvalueDecomposition = function EigenvalueDecomposition(matrix, options) {
    ...
    self.tred2 = function tred2(n, e, d, V) {
    ...
    self.tql2 = function tql2(n, e, d, V) {
    ...
    self.orthes = function orthes(n, H, ort, V) {
    ...
    self.hqr2= function hqr2(nn, e, d, V, H) {
        var n = nn - 1,
            low = 0,
            high = nn - 1,
            eps = Math.pow(2, -52),
    ...
    self.cdiv= function cdiv(xr, xi, yr, yi) {
        var r, d;
...
let MLMatrixDCQR;
{
    ...
    self.QrDecomposition = function QrDecomposition(value) {
